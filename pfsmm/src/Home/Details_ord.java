 ...
 * @author LATITUDE
 */
public class Details_ord extends javax.swing.JPanel {
Statement stt ;
    ...
    /**
     * Creates new form Details_ord
     */
    public Details_ord(int id) {
        initComponents();
        ct = (DefaultTableModel)(OrderedTable.getModel());
        try{
            stt = cnn.obtenirconnexion().createStatement() ; 
            rs = stt.executeQuery("SELECT * FROM `detaild` where idcmd = "+id+" ") ;  
           
           while(rs.next()){
                ct.addRow(new Object [] {rs.getInt("idcmd"),rs.getInt("idProduit") ,rs.getInt("quantity")});
           }
        }catch(Exception e){
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
       ...
       try{
            ...
            stt.executeQuery("INSERT INTO `details`(`idcmd`,`idProduct`, `quantity`) VALUES ("+idc+" , "+product+","+qte+")" );
        }catch(Exception e){
    ...
    private void EDITActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EDITActionPerformed
       ...
       // stt.executeUpdate("UPDATE employee SET name="+tnom.getText().toString()+" ,grp="+tgrp.getText().toString()+", pre="+tpre.getText().toString()+" WHERE idemp="+tcin.getText().toString());
        stt.executeUpdate("UPDATE details SET idProduct='" + productcomb.getSelectedItem().toString() + "' ,idcmd ='" + Integer.valueOf(idcmd.getText()) + "', quantity='"
        ...
        try
        {
            if(JOptionPane.showConfirmDialog(null, "Do you really want to delete that ligne de commande ?", "DELET", JOptionPane.YES_NO_OPTION)==JOptionPane.OK_OPTION)
            {
                if(idcmd.getText().length() != 0){
                    stt.executeUpdate("DELETE FROM details WHERE idcmd ='" + idcmd.getText() + "' AND idProduit = "+productcomb.getSelectedItem().toString()+" ");
                    // refresh();
